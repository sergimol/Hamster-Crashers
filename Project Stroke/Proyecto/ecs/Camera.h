...
public:
	...
	void resetCamera();
	Vector2D cameraFollowPos_;	//Guarda el punto de la posici�n de la camara cuando lo lea
...
guardar un array de posiciones de la camara, puesto que cuando se entre en una nueva zona, solo habr� una nueva
posici�n de la camara a la que esta tendra que ir
*/
