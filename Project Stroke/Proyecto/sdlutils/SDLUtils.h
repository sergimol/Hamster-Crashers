...
private:
	...
	int hamstersToChoose_; // n�mero de hamsters a elegir en el men� de selecci�n
	int hamstersChosen_; // n�mero de hamstes ya elegidos
	...
	// Indice de la resoluci�n actual dentro de los arrays
